...
import Galaxina_Bot.modules.sql.connection_sql as sql
from Galaxina_Bot import dispatcher, DRAGONS, DEV_USERS
from Galaxina_Bot.modules.helper_funcs import chat_status
