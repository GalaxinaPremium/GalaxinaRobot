...
import Galaxina_Bot.modules.sql.notes_sql as sql
from Galaxina_Bot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Galaxina_Bot.__main__ import DATA_IMPORT
from Galaxina_Bot.modules.helper_funcs.chat_status import user_admin
from Galaxina_Bot.modules.helper_funcs.alternate import typing_action

# from Galaxina_Bot.modules.rules import get_rules
import Galaxina_Bot.modules.sql.rules_sql as rulessql

# from Galaxina_Bot.modules.sql import warns_sql as warnssql
import Galaxina_Bot.modules.sql.blacklist_sql as blacklistsql
from Galaxina_Bot.modules.sql import disable_sql as disabledsql

# from Galaxina_Bot.modules.sql import cust_filters_sql as filtersql
# import Galaxina_Bot.modules.sql.welcome_sql as welcsql
import Galaxina_Bot.modules.sql.locks_sql as locksql
from Galaxina_Bot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Galaxina_Bot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Galaxina_Bot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Galaxina_Bot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Galaxina_Bot{}.backup".format(chat_id))  # Cleaning file
