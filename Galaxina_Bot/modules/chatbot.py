...
import html
import requests
import Galaxina_Bot.modules.sql.chatbot_sql as sql
...
from Galaxina_Bot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Galaxina_Bot import dispatcher, updater, SUPPORT_CHAT
from Galaxina_Bot.modules.log_channel import gloggable
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ɢᴀʟᴀxɪɴᴀ ✘ ʀᴏʙᴏᴛ ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ɢᴀʟᴀxɪɴᴀ ✘ ʀᴏʙᴏᴛ ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(
                    mention_html(user.id, user.first_name)
                ),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Galaxina Enabled Chats</b>\n"
    for chat in chats:
        try:
